if (this.JSON && this.JSON.stringify.toString().indexOf("[native code]") !== -1) {
    ...
    var a = {
        browser: function() {
            ...
            var d; (d = c.match(/msie ([\d.]+)/)) ? e.msie = d[1] : (d = c.match(/firefox\/([\d.]+)/)) ? e.firefox = d[1] : (d = c.match(/chrome\/([\d.]+)/)) ? e.chrome = d[1] : (d = c.match(/opera.([\d.]+)/)) ? e.opera = d[1] : (d = c.match(/version\/([\d.]+).*safari/)) ? e.safari = d[1] : 0;
            return e
        } (),
        isDOM: function(c) {
        ...
        getDocumentCharset: function() {
            a.log("document.characterSet || document.charset:::" + document.characterSet || document.charset);
        ...
        css: function() {
            var c = function(h, d) {
                ...
                if ((i == "auto" || i.indexOf("%") !== -1) && ("width" === d.toLowerCase() || "height" === d.toLowerCase()) && h.style.display != "none" && i.indexOf("%") !== -1) {
                    i = h["offset" + d.charAt(0).toUpperCase() + d.substring(1).toLowerCase()] + "px"
                }
                if (d == "opacity") {
                    try {
        ...
        createJTRAssist: function(h, e) {
            ...
            var j = function() {
                ...
                if (a.browser.msie === "6.0" || a.browser.msie === "7.0") {
                    l.innerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1" height="1" id="' + h + '"><param name="allowScriptAccess" value="always" /><param name="movie" value="' + d + '" /></object>'
                } else {
                    l.innerHTML = '<object height="1" width="1" id="' + h + '" data="' + d + '"><param name="allowScriptAccess" value="always"></object>'
                }
    ...
    TR = function(d, b, g, c) {
        ...
        this._onStatusChange = b.onStatusChange ||
        function() {};
        this._url = b.url;
        this.conn = g;
        this._context = d;
            ...
            for (var g = 0; g < this._nodeIndex.length; g++) {
                if (this._manager.transResults[g]) {
                    ...
                    if (j[parseInt(f / this._reqSize, 10)]) {
                        e = j[parseInt(f++/this._reqSize,10)]}else{e=j[parseInt(f++/this._reqSize, 10)] = {}
                    }
                    var i = null;
                    try {
                        i = this._manager.nodes[g].parentNode && this._manager.nodes[g].parentNode.tagName || null
                    } catch(c) {}
                    e[g] = {
                        src: this._manager.originals[g],
                        tag: i
                    }
                }
            }
            ...
            for (var h = 0; h < this._nodeIndex.length; h++) {
                if (this._manager.tipsResults[h]) {
                    ...
                    if (k[parseInt(g / this._reqSize, 10)]) {
                        f = k[parseInt(g++/this._reqSize,10)]}else{f=k[parseInt(g++/this._reqSize, 10)] = {}
                    }
                    var j = null;
                    try {
                        j = this._manager.nodes[h].parentNode && this._manager.nodes[h].parentNode.tagName || null
                    } catch(d) {}
                    f[h] = {
                        src: this._manager.originals[h],
                        tag: j
                    }
                }
            }
    ...
    TR.isInclude = function(b) {
        return ! (b.tagName === "SCRIPT" || b.tagName === "STYLE" || b.tagName === "PRE" || (b.className && b.className.indexOf && b.className.indexOf("OUTFOX_JTR_") !== -1))
    };
    a.TR = TR
})(J);
if (!J || !J.bind) {
    ...
    var e = {
        ...
        isKoera: function(k) {
            for (i = 0; i < k.length; i++) {
                if (((k.charCodeAt(i) > 12592 && k.charCodeAt(i) < 12687) || (k.charCodeAt(i) >= 44032 && k.charCodeAt(i) <= 55203))) {
                    return true
                }
            }
            return false
    ...
    a.fn = a.prototype = {
        ...
        swipeWord: function(p, k, q, o, n) {
            ...
            if ((!e.isContainChinese(p) && c(p) >= 3) || (e.isContainChinese(p) || e.isContainJapanese(p) && p.length > 4)) {
                m = "translate"
            } else {
                m = "dict"
            }
        ...
        if (window.chrome && window.chrome.extension && window.chrome.extension.sendRequest) {
            n = {
                request: function(p, q) {
                    window.chrome.extension.sendRequest(p,
                    function(r) {
                        if (r) {
    ...
    a.processXmlTransData = function(r) {
        var l = (r.getElementsByTagName("input")[0].childNodes[1] || r.getElementsByTagName("input")[0].childNodes[0]).nodeValue,
        q = (r.getElementsByTagName("translation")[0].childNodes[1] || r.getElementsByTagName("translation")[0].childNodes[0]).nodeValue,
        p = r.getElementsByTagName("response")[0].getAttribute("errorCode") - 0,
        n = h.trim(q),
        m = h.trim(l);
        if ((e.isContainChinese(m) || e.isContainJapanese(m) || e.isContainKoera(m)) && m.length > 15) {
            m = m.substring(0, 8) + " ..."
        } else {
            if (m.length > 25) {
                m = m.substring(0, 15) + " ..."
    ...
    a.processXmlDictData = function(D) {
        ...
        if ((l = D.getElementsByTagName("web-translation")) && l.length > 0) {
            for (w = 0; w < l.length - 1; w++) {
                z.push({
                    ...
                    value: l[w].getElementsByTagName("trans")[0].getElementsByTagName("value")[0].firstChild.nodeValue
                })
            }
        }
        var B = "http://dict.youdao.com/search?q=" + encodeURIComponent(x) + "&keyfrom=chrome.extension" + F,
        E = x,
        A = "",
        o = "",
        m = "",
        ...
        s = "";
        s = '<div class="ydd-container">                      <div class="ydd-top-wrapper">                        <div class="ydd-top"></div>                      </div>                      <div class="ydd-body-wrapper">                        <div class="ydd-lb"></div>                        <div class="ydd-rb"></div>                        <div class="ydd-body">                          <div class="ydd-titile">                            <span class="ydd-key-title">{title}</span>                            <span class="ydd-phonetic">{phonetic}</span> {speechHTML} <span class="ydd-detail"><a href="{searchURL}" target="_blank">详细&rsaquo;&rsaquo;</a></span>                          </div>                          <div class="ydd-middle">                            <div class="ydd-trans-wrapper ydd-base-trans">                              <div class="ydd-tabs"><span class="ydd-tab">基本翻译</span></div>{baseTransHTML}</div>                              <div class="ydd-trans-wrapper ydd-web-trans">                                <div class="ydd-tabs"><span class="ydd-tab">网络释义</span></div>{webTransHTML}</div>                              </div>                            </div>                          </div>                        <div class="ydd-bottom-wrapper">                          <div class="ydd-bottom"><a href="' + C + '" target="_blank" title="使用有道搜索 {title}">搜索&nbsp;{title}</a></div>                        </div>                        <div class="ydd-bg-top"></div>                      </div>                    </div>';
        if ((e.isContainChinese(E) || e.isContainJapanese(E) || e.isContainKoera(E)) && E.length > 15) {
            E = E.substring(0, 10) + "..."
        } else {
            if (E.length > 25) {
                E = E.substring(0, 15) + " ..."
        ...
        if (q.length + z.length > 0 && v) {
            A = '<span class="ydd-voice">' + j("http://dict.youdao.com/speech?audio=" + v, "test", "CLICK", "dictcn_speech") + "</span>"
        }
        for (w = 0; w < q.length; w++) {
            o += '<div class="ydd-trans-container">' + q[w] + "</div>"
        }
        for (w = 0; w < z.length; w++) {
            var p = "http://dict.youdao.com/search?q=" + encodeURIComponent(z[w].key) + "&keyfrom=chrome.extension" + F;
            m += '<div class="ydd-trans-container"><a href="' + p + '" target="_blank">' + z[w].key + ":</a> " + z[w].value + "</div>"
        }
    ...
    b.prototype = {
        ...
        _moveHandler: function(e, i) {
            var f = e.clientX - 1 / 2 * this.controller.clientWidth - a.findPos(this.container).x - this.borderFix,
    ...
    b.prototype = {
        ...
        _getAllArticle: function() {
            ...
            e = [];
            for (var d = 0,
            h = f.length > 100 ? 100 : f.length; d < h; d++) {
                var g = f[d];
        ...
        _checkVisibility: function(d) {
            return ! (a.css(d, "visibility") == "hidden" || a.css(d, "display") == "none" || parseInt(a.css(d, "height")) <= 0 || parseInt(a.css(d, "width")) <= 0)
        },
    ...
    a.TR.UI = function(e, f) {
        ...
        function() {
            ...
            var i = function(j) {
                ...
                g.enable();
                g.writeSettings({
                    runCount: g.settings.runCount + 1
                });
                a.each(c,
                function(k, l) {
    ...
    a.TR.UI.prototype = {
                ...
                if (f.status === "finish") {
                    ...
                    if (this.mode === "TRANS") {
                        ...
                        if (e !== 0) {
                            ...
                            this.statusElem.innerHTML = '共注释<span class="OUTFOX_BAR_TOTAL_NUM">' + e + "</span>个难词"
                        } else {
        ...
        initFrame: function(f, i) {
            ...
            function g(k) {
                ...
                if (a.browser.msie && document.domain != window.location.hostname) {
                    j.src = "javascript:void(document.write(\"<script>document.domain='" + document.domain + "';<\/script><body></body>\"))"
                }
                if (a.browser.msie && !(a.browser.msie === "8.0" && document.compatMode === "CSS1Compat")) {
                    a.css(j, {
                        width: a.getPageSize().window.width + "px"
                    });
        ...
        initTipContent: function() {
            ...
            var e = function() {
                ...
                i.innerHTML = "更新提示：<br/>" + d.updateTipMsg + '<span class="update-date">' + d.updateDate + '</span><a href="javascript:void(0);" id="OUTFOX_JTR_BAR_CLOSE_UPDATE_TIP_CONTENT_CLOSE"></a>';
        ...
        initTipsCtrl: function() {
            ...
            this.tipsCtrlHandler = function(j) {
                ...
                k = 0;
                clearTimeout(e);
                if (i === d.tipsTarget || i.className && i.className.indexOf("OUTFOX_JTR_NANCI_") !== -1) {
                    return
                }
        ...
        preventClose: function() {
            a.css(a.query("#OUTFOX_JTR_BAR_CLOSE", this.frame), {
                display: "none"
            })
        },
        ...
        initTransTip: function(d) {
            ...
            this.transTipHandler = function(j) {
                ...
                clearTimeout(e);
                e = setTimeout(function() {
                    if (g === i || i.className && (i.className.indexOf("OUTFOX_JTR_TRANSTIP_") !== -1 || i.className.indexOf("ydd-") !== -1)) {
                        return
                    }
                    if (g) {
        ...
        initTransTipElem: function() {
            ...
            g.innerHTML += '<div class="OUTFOX_JTR_TRANSTIP_ORIGIN">                                        <div class="ydd-container">                                          <div class="ydd-top-wrapper">                                            <div class="ydd-top">                                            </div>                                          </div>                                          <div class="ydd-body-wrapper">                                            <div class="ydd-lb"></div>                                            <div class="ydd-rb"></div>                                            <div class="ydd-body">                                              <div class="ydd-title">                                                <strong>原文：</strong>                                              </div>                                              <div class="ydd-middle">                                                <div class="OUTFOX_JTR_TRANSTIP_ORIGIN_TEXT"></div>                                                <div class="OUTFOX_JTR_TRANSTIP_ADVISE">                                                  <textarea class="OUTFOX_JTR_TRANSTIP_ADVISE_TEXT"></textarea>                                                  <a class="OUTFOX_JTR_TRANSTIP_ADVISE_SUBMIT" href="javascript:void(0);">提交翻译建议</a>                                                </div>                                              </div>                                            </div>                                          </div>                                          <div class="ydd-bottom-wrapper">                                            <div class="ydd-bottom">                                              <a class="OUTFOX_JTR_TRANSTIP_ADVISE_TOGGLE">更好的翻译建议</a>                                              <span class="OUTFOX_JTR_TRANSTIP_ADVISE_THANK">感谢您为有道提供建议^_^</span>                                            </div>                                          </div>                                          <div class="ydd-bg-top"></div>                                        </div>                                      </div>';
        ...
        resetTransTipElem: function(d, f, e) {
            ...
            a.css(this.transTipElem.toggle, {
                display: ""
            });
